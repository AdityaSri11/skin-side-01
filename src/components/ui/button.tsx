  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-primary-foreground font-semibold hover:scale-105 hover:shadow-xl transition-all duration-300",
        healthcare: "bg-healthcare-blue text-white hover:bg-healthcare-blue/90 shadow-lg hover:shadow-xl",
        healing: "bg-healing-green text-accent-foreground hover:bg-healing-green/80 border border-accent",
        soft: "bg-skin-tone text-secondary-foreground hover:bg-skin-warm shadow-md hover:shadow-lg",
      },
      size: {
