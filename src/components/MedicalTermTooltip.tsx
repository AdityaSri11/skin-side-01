...
const MEDICAL_TERMS: Record<string, string> = {
  ...
  "randomized": "Participants are placed into groups by chance. Each person has an equal chance of receiving any of the treatments being compared.",
  "randomised": "Participants are placed into groups by chance. Each person has an equal chance of receiving any of the treatments being compared.",
  "random": "Participants are placed into groups by chance. Each person has an equal chance of receiving any of the treatments being compared.",
  "double-blind": "Neither the participants nor the doctors know who is getting the real treatment or the placebo.",
  "double blind": "Neither the participants nor the doctors know who is getting the real treatment or the placebo.",
  "multi-center": "Happens at more than one hospital or clinic.",
  "multicenter": "Happens at more than one hospital or clinic.",
  "multi-centre": "Happens at more than one hospital or clinic.",
  "multicentre": "Happens at more than one hospital or clinic.",
  "follow-up": "Checking on participants after treatment ends to see how they're doing — through visits, phone calls, or tests.",
  "followup": "Checking on participants after treatment ends to see how they're doing — through visits, phone calls, or tests.",
  "follow up": "Checking on participants after treatment ends to see how they're doing — through visits, phone calls, or tests.",
  "not yet recruiting": "Study has been approved but hasn't started enrolling participants yet.",
  "recruiting": "Study is actively looking for people to join.",
  "enrolling by invitation": "Only people who are specifically invited by the research team can take part.",
  "active, not recruiting": "Study is still ongoing, but it's not taking in any new participants.",
  "active not recruiting": "Study is still ongoing, but it's not taking in any new participants.",
  "suspended": "Study has been temporarily stopped.",
  "terminated": "Study was stopped early and will not restart.",
  "completed": "Study has finished.",
  "withdrawn": "Study was approved but never began.",
  "authorized": "Study or treatment has been reviewed and cleared by regulators.",
  "approved": "Study or treatment has been reviewed and cleared by regulators.",
